...
const string COMMA = ",";
const string DOT   = ".";
const string SCOPE_RESOLUTION_OP = "::";
...
const string ASSIGN = "=";
const string BIT_OR = "\\|";
const string BIT_AND = "&";
const string BIT_XOR = "\\^";
const string MODULO = "%";
const string LOGICAL_NOT = "!";
const string LOGICAL_AND = "&&";
const string LOGICAL_OR = "\\|\\|";
const string LOGICAL_EQUAL = "==";
const string LOGICAL_NOT_EQUAL = "!=";
...
const string DIRECT_SELECTION_OPERATOR = "\\.";
const string LOGICAL_OPERATORS = "(" + LOGICAL_EQUAL + ")|(" + LOGICAL_NOT + ")|(" + LOGICAL_NOT_EQUAL + ")|(" + LOGICAL_AND + ")|(" + LOGICAL_OR + ")|(" + LESS_THAN + ")|(" + GREATER_THAN + ")|(" + LESS_THAN_EQUAL + ")|(" + GREATER_THAN_EQUAL + "))";
const string OPERATORS = "([\\s,/'\"$*#=+-:!%<>|.(){}\\]\\[])";
const string LITERALS = "([\\w\\s\\[\\]+-=|$><^/#@~&*.%!~`_:;'\\\\,()]*)";
const string FILE_NAME = "([A-Za-z0-9_. ]+)";
...
enum token_id : unsigned long
{
    ...
    ID_CLOSE_BRACE             = 80,
    ID_LITERAL                 = 100,
    ID_OPEN_CURLY_BRACE        = 110,
    ID_CLOSE_CURLY_BRACE       = 120,
    ID_ASTERIK                 = 130,
    ID_HASH_MARK               = 140,
    ID_DOLLAR_SIGN             = 150,
    ID_DOT                     = 160,
